...
# How long an answer takes, more than anything else. 0 = thinking off; see
# agent/config.py::DEFAULT_THINKING_BUDGET for the measurements.
ENV_VARS+=",TURNAROUND_THINKING_BUDGET=${TURNAROUND_THINKING_BUDGET:-0}"
ENV_VARS+=",TURNAROUND_PUBLIC_DOCS=${TURNAROUND_PUBLIC_DOCS:-1}"
